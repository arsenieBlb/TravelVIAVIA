...
public class MyBookingsViewController
{
    ...
    public void init(FlightSceneViewController parentController, MyBookingsViewModel viewModel, Region root)
    {
        ...
        addBookingButton.setOnAction(event -> parentController.showAddBookingDialog());
        emptyBookingsPane.setOnMouseClicked(event -> parentController.showAddBookingDialog());
    ...
    private VBox createBookingCard(Booking booking)
    {
        ...
        card.setOnMouseClicked(event -> {
            parentController.showBookingDetails(booking);
            event.consume();
        });
