...
import servermodel.dto.AddBookingByIdRequest;
import servermodel.dto.BookingDto;
import servermodel.dto.BookingRequest;
import servermodel.dto.CarrierDto;
import servermodel.dto.CityDto;
import servermodel.dto.DtoMapper;
import servermodel.dto.FlightDto;
import servermodel.dto.IdRequest;
import servermodel.dto.LoginRequest;
import servermodel.dto.LuggageTypeDto;
import servermodel.dto.PlaneDto;
import servermodel.dto.RegisterRequest;
import servermodel.dto.SearchFlightsRequest;
import servermodel.dto.UserDto;
    ...
    catch (IOException e)
    {
      throw new IllegalStateException(
          "Could not connect to TravelVIAVIA server at " + host + ":" + port
              + ". Start servermediator.ServerMain first.", e);
    }
  }
